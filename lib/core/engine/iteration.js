...
class Iteration {
  ...
  async run(navigationScript, index) {
    ...
    log.info("making opts");
    const options = this.options;

    log.info("making selenium runner");
    const browser = new SeleniumRunner(
      this.storageManager.directory,
      this.options
    );

    log.info("making new video");
